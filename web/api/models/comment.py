...
class Comment(models.Model):
    ...
    commented_comment = models.ForeignKey('self', related_name='Commented Comment', null=True, blank=True)
    commented_event = models.ForeignKey(Event, related_name='Commented Event', null=True, blank=True)

...
urlpatterns = patterns('',
    ...
    url(r'^api/get_owned_groups/$', group_views.get_owned_groups, name='api_get_owned_groups'),
    url(r'^api/get_participant_groups/$', group_views.get_participant_groups, name='api_get_participant_groups'),
